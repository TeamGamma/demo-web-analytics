...
var option_enabled = function(opt) {
  return opt in options && options[opt] === true; 
}

var init = function() {
  console.log(options);

  if(option_enabled('solace-sidebar')) {
      console.log('using sidebar');
  } else {
      console.log(' not using sidebar');
    }
...
(function($){
    $.fn.tabSlideOut = function(callerSettings) {
        ...
        var properties = {
                    containerWidth: parseInt(obj.outerWidth(), 10) + 21 + 'px',
...
// JavaScript Document
// This code modifies page based on scrolling location
